...
v1.0.0 发布验收必须覆盖：完整 pytest、clean build、主 EXE packaged self-test、MCP packaged smoke、秘密扫描、哈希、安装覆盖、数据保留、桌面快捷方式目标、快捷方式实际启动、版本、主导航、单实例、托盘、邮件级收件详情、完整发件、历史记录、文件与数据、设置和发件内 MCP。
